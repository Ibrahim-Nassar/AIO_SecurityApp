...
class AssistantPage(QWidget):
    ...
    def _on_answer(self) -> None:
        ...
        lines.append("- For URLs, check urlscan verdicts/tags; pivot to reports for details.")
        lines.append("- Cross-check OTX pulses and AbuseIPDB confidence/totalReports for corroboration.")
        lines.append("")
