...
class BusyOverlay(QWidget):
    """Semi-transparent overlay with a simple spinner.

    Usage:
      overlay = BusyOverlay(parent_page)
      overlay.show_over(parent_page)
      overlay.hide()
    """
...
class Toast(QWidget):
    ...
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        # Light theme: dark slate background with subtle border
